<script type="text/javascript">
    ...
    function WDPButtonClick() {
        ...
        jQuery("#wdp-dialog").dialog({ dialogClass: 'wdp-dialog', autoOpen: false, width: 750, minWidth: 750, maxWidth: 750, height: 580, minHeight: 580, maxHeight: 650, title: title, buttons: buttons, resizable: true });
